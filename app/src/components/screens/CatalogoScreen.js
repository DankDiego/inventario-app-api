          ...
          {productos.map((val, key) => {
            return (
              <div className='place-self-stretch' key={key}>
                <div className='max-w-xs bg-gray-800 shadow-lg rounded-lg overflow-hidden my-10'>
                  <div className='px-4 py-2'>
                    <h1 title={val.nombreproducto} className='text-white truncate h-34 hover:bg-black font-bold text-2xl uppercase'>{val.nombreproducto}</h1>
